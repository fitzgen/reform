...
var BaseFormField = _safe_new_wrap(function () {});
...
var TextField = _safe_new_wrap(function (options) {
...
var TextAreaField = _safe_new_wrap(function (options) {
    util.update(this, options);
});
...
var EmailField = _safe_new_wrap(function (options) {
    util.update(this, options);
});
...
var PasswordField = _safe_new_wrap(function (options) {
    util.update(this, options);
});
...
var IntegerField = _safe_new_wrap(function (options) {
    util.update(this, options);    
});
...
var BaseChoiceField = _safe_new_wrap(function () {});
...
var RadioChoiceField = _safe_new_wrap(function (options) {
    util.update(this, options);
});
...
var DropdownField = _safe_new_wrap(function (options) {
    util.update(this, options);
});
